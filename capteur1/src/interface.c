...
create_ajouter_capteur (void)
{
  ...
  gtk_fixed_put (GTK_FIXED (fixed2), type, 48, 144);
  gtk_widget_set_size_request (type, 56, 25);

  cb_type_ajout = gtk_combo_box_new_text ();
  gtk_widget_show (cb_type_ajout);
  gtk_fixed_put (GTK_FIXED (fixed2), cb_type_ajout, 136, 136);
  gtk_widget_set_size_request (cb_type_ajout, 160, 31);
  gtk_combo_box_append_text (GTK_COMBO_BOX (cb_type_ajout), _("Temp\303\251rature "));
  gtk_combo_box_append_text (GTK_COMBO_BOX (cb_type_ajout), _("Humidit\303\251 "));
  ...
  GLADE_HOOKUP_OBJECT (ajouter_capteur, cb_type_ajout, "cb_type_ajout");
...
create_modifier_capteur (void)
{
  ...
  gtk_combo_box_append_text (GTK_COMBO_BOX (cb_type_modif), _("Humidit\303\251 "));

  marque = gtk_label_new (_("Marque "));
  gtk_widget_show (marque);
  gtk_fixed_put (GTK_FIXED (fixed3), marque, 64, 128);
  gtk_widget_set_size_request (marque, 60, 17);

  cb_id_modif = gtk_combo_box_new_text ();
  gtk_widget_show (cb_id_modif);
  gtk_fixed_put (GTK_FIXED (fixed3), cb_id_modif, 160, 64);
  gtk_widget_set_size_request (cb_id_modif, 160, 24);
  gtk_combo_box_append_text (GTK_COMBO_BOX (cb_id_modif), _("id"));
...
create_supprimer_capteur (void)
{
  ...
  gtk_widget_set_size_request (combobox_supp, 105, 31);
  gtk_combo_box_append_text (GTK_COMBO_BOX (combobox_supp), _("id"));
